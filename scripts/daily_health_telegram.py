...
def run():
    ...
    # Missing funeral_home count
    cur.execute("SELECT COUNT(*) as cnt FROM obituaries WHERE funeral_home IS NULL AND is_deleted = 0")
    missing_fh = cur.fetchone()["cnt"]
    ...
    lines += [
        ...
        f"  Missing funeral_home: {missing_fh:,}",
    ]
